...
[h,{dataSrc:c,nodes:l,values:i}]);this.c.editor&&this.c.editor.edit(l,!1,{submit:"changed"}).multiSet(c,i).submit();if(this.c.update){a=0;for(d=h.length;a<d;a++)f=b.row(h[a].node).data(),p(f,h[a].newData),b.columns().every(function(){this.dataSrc()===c&&b.cell(h[a].node,this.index()).invalidate("data")});b.draw(!1)}}});i.defaults={dataSrc:0,editor:null,selector:"td:first-child",snapX:!1,update:!0};i.version="1.1.0-dev";e.fn.dataTable.RowReorder=i;e.fn.DataTable.RowReorder=i;e(g).on("init.dt.dtr",
function(b,a){if("dt"===b.namespace){var d=a.oInit.rowReorder,c=h.defaults.rowReorder;if(d||c)c=e.extend({},d,c),!1!==d&&new i(a,c)}});return i});
