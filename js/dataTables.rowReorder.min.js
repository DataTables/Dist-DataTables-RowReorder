...
this,b=this.s.dt,a=e(b.table().node());"static"===a.css("position")&&a.css("position","relative");e(b.table().container()).on("mousedown.rowReorder touchstart.rowReorder",this.c.selector,function(a){if(c.c.enabled){var i=e(this).closest("tr"),g=b.row(i);if(g.any())return c._emitEvent("pre-row-reorder",{node:g.node(),index:g.index()}),c._mouseDown(a,i),!1}});b.on("destroy.rowReorder",function(){e(b.table().container()).off(".rowReorder");b.off(".rowReorder")})},_cachePositions:function(){var c=this.s.dt,
...
o&&(f[o]=m(p));j.push({node:l[a],oldData:m(q),newData:m(p),newPosition:a,oldPosition:e.inArray(l[a],g)});k.push(l[a])}g=[j,{dataSrc:i,nodes:k,values:f,triggerRow:b.row(this.dom.target)}];this._emitEvent("row-reorder",g);this.c.editor&&(this.c.enabled=!1,this.c.editor.edit(k,!1,e.extend({submit:"changed"},this.c.formOptions)).multiSet(i,f).one("submitComplete",function(){c.c.enabled=!0}).submit());if(this.c.update){a=0;for(d=j.length;a<d;a++)f=b.row(j[a].node).data(),n(f,j[a].newData),b.columns().every(function(){this.dataSrc()===
...
h.body.scrollTop+a.windowVert;if(a.dtVert){var c=b.dom.dtScroll[0];if(a.dtVert)c.scrollTop=c.scrollTop+a.dtVert}},20))}});j.defaults={dataSrc:0,editor:null,enabled:!0,formOptions:{},selector:"td:first-child",snapX:!1,update:!0};var m=e.fn.dataTable.Api;m.register("rowReorder()",function(){return this});m.register("rowReorder.enable()",function(c){c===n&&(c=!0);return this.iterator("table",function(b){b.rowreorder&&(b.rowreorder.c.enabled=c)})});m.register("rowReorder.disable()",function(){return this.iterator("table",
function(c){c.rowreorder&&(c.rowreorder.c.enabled=!1)})});j.version="1.2.0";e.fn.dataTable.RowReorder=j;e.fn.DataTable.RowReorder=j;e(h).on("init.dt.dtr",function(c,b){if("dt"===c.namespace){var a=b.oInit.rowReorder,d=k.defaults.rowReorder;if(a||d)d=e.extend({},a,d),!1!==a&&new j(b,d)}});return j});
